...
## O que a evidência diz sobre a cobertura {#o-que-a-evidencia-diz-sobre-a-cobertura .smaller}
...
**O algoritmo de ranqueamento não é publicado** — você não consegue auditar por que um artigo ficou em primeiro lugar e outro em décimo.

::: {.fonte}
Descrição do método conforme o material público da própria Consensus.
:::
...
## Referências {#referencias .smaller}
...
## Referências {#referencias-2 .smaller}
