...
## Como este workshop funciona {#como-este-workshop-funciona .smaller}
...
## O que você precisa ter aberto agora {#o-que-voce-precisa-ter-aberto-agora .smaller}
...
# 0 · De onde viemos {#0-de-onde-viemos .bsl-secao background-color="#f3eee3"}

## A palestra anterior parou em "declare" {#a-palestra-anterior-parou-em-declare .smaller}
...
## Três teses que este workshop defende {#tres-teses-que-este-workshop-defende .smaller}
...
# 1 · A web que os robôs leem {#1-a-web-que-os-robos-leem .bsl-secao background-color="#f3eee3"}

## Demonstração ao vivo · a alucinação acontecendo [8 min]{.cronometro} {#demonstracao-ao-vivo-a-alucinacao-acontecendo .smaller}

Antes de qualquer slide sobre o problema, vamos **produzir o problema** aqui, agora, juntos.

::: {.bsl-exercicio}
```{=html}
<h4>Protocolo — façam junto comigo</h4>
```
...
## O verificador (rodando ao vivo) {#o-verificador-rodando-ao-vivo .smaller}
...
## Por que aquilo aconteceu {#por-que-aquilo-aconteceu .smaller}

A explicação que você vai ouvir — e que eu já dei, errada, para o meu próprio orientando — é *"o modelo não tinha acesso à internet"*.

::: {.bsl-alerta}
**Está errada.** Falta de acesso **não é** a causa da invenção de referências. São dois mecanismos independentes, e tratar um como causa do outro leva à conclusão falsa de que "se o site abrisse, o modelo não inventaria". Ele inventaria do mesmo jeito.
:::
...
## Os dois mecanismos, lado a lado {#os-dois-mecanismos-lado-a-lado .smaller}
...
<svg viewBox="0 0 1120 360" width="100%" style="max-height:430px" role="img"
  ...
  <text x="840" y="166" text-anchor="middle" font-family="sans-serif" font-size="11.5" fill="#59616b">(os três, ao vivo, no fim deste bloco)</text>
...
Abrir o site bloqueado resolve **B**, e não toca em **A**.

::: {.fonte}
Diagrama original · CC BY 4.0.
:::


## A escala, medida na literatura publicada {#a-escala-medida-na-literatura-publicada .smaller}
...
## Quem é mais atingido {#quem-e-mais-atingido .smaller}
...
## Quanto se inventa, em condição controlada {#quanto-se-inventa-em-condicao-controlada .smaller}
...
## Uma lição de medição, de graça {#uma-licao-de-medicao-de-graca .smaller}
...
## E a alucinação não é uniforme no globo {#e-a-alucinacao-nao-e-uniforme-no-globo .smaller}
...
## Em junho de 2026, os robôs passaram as pessoas {#em-junho-de-2026-os-robos-passaram-as-pessoas .smaller}

::: {.bsl-destaque}
Até aqui, o **mecanismo A**. O resto deste bloco é sobre o **B** — por que a ferramenta que *tem* busca ainda assim recupera pouco. E isso começa longe da ciência: começa em como a web mudou.
:::
...
## O Brasil não é a média mundial {#o-brasil-nao-e-a-media-mundial .smaller}
...
Os números mudam de semana para semana — por isso não estão fixados em nenhum slide.

::: {.fonte}
Cloudflare Radar, painel público por país.
:::

## "Teoria da internet morta": o que ela acerta e o que ela erra {#teoria-da-internet-morta-o-que-ela-acerta-e-o .smaller}
...
O verbete abaixo reúne a origem, as formulações e a recepção da ideia. É **fonte terciária**: serve para documentar o que a teoria afirma e de onde ela veio — não para sustentar afirmação empírica. Os números deste bloco vêm das fontes primárias dos outros slides.

::: {.fonte}
*Dead Internet theory*: <https://en.wikipedia.org/wiki/Dead_Internet_theory>
:::

## Por que uma página deixou de ser um documento {#por-que-uma-pagina-deixou-de-ser-um-documento .smaller}
...
Isso se chama *client-side rendering*. Não é conspiração contra robôs: é escolha de arquitetura feita por outras razões — interatividade, custo de servidor. O efeito colateral é que a web ficou **mais cara de ler por máquina**.

## Demonstração 1 · a casca vazia {#demonstracao-1-a-casca-vazia .smaller}
...
## Por que o robô é barrado: quatro motivos distintos {#por-que-o-robo-e-barrado-quatro-motivos .smaller}
...
## Demonstração 2 · o 403 {#demonstracao-2-o-403 .smaller}
...
Ambos os casos ocorreram durante a preparação destes slides, em setembro de 2026. O mesmo artigo foi obtido depois por uma **API** — que é exatamente a saída do bloco 2.

## O que muda na revisão de literatura {#o-que-muda-na-revisao-de-literatura .smaller}
...
# 2 · Bases legíveis por máquina {#2-bases-legiveis-por-maquina .bsl-secao background-color="#f3eee3"}

## O que faz uma base ser "legível por máquina" {#o-que-faz-uma-base-ser-legivel-por-maquina .smaller}
...
## Semantic Scholar {#semantic-scholar .smaller}
...
## Quanto cada base cobre, em escala {#quanto-cada-base-cobre-em-escala .smaller}

```{=html}
<svg viewBox="0 0 1120 440" width="100%" style="max-height:360px" role="img"
     aria-label="Diagrama de Euler: as 16,8 milhões de publicações comuns às três bases representam 74,3% da Web of Science, 60,8% da Scopus e apenas 21,8% do OpenAlex no período 2015-2022.">
  <circle cx="360" cy="230" r="190" fill="#1c6e8c" fill-opacity="0.12" stroke="#1c6e8c" stroke-width="2"/>
  <circle cx="470" cy="180" r="103" fill="#a8710a" fill-opacity="0.16" stroke="#a8710a" stroke-width="2"/>
  <circle cx="500" cy="280" r="114" fill="#2f6f3e" fill-opacity="0.16" stroke="#2f6f3e" stroke-width="2"/>

  <text x="360" y="60"  text-anchor="middle" font-family="sans-serif" font-size="17" font-weight="600" fill="#144f64">OpenAlex</text>
  <text x="470" y="104" text-anchor="middle" font-family="sans-serif" font-size="15" font-weight="600" fill="#8a5c08">Web of Science</text>
  <text x="560" y="386" text-anchor="middle" font-family="sans-serif" font-size="15" font-weight="600" fill="#2f6f3e">Scopus</text>

  <text x="487" y="228" text-anchor="middle" font-family="sans-serif" font-size="19" font-weight="600" fill="#2d3748">16,8 M</text>
  <text x="487" y="248" text-anchor="middle" font-family="sans-serif" font-size="13" fill="#59616b">nas três</text>

  <line x1="10" y1="60" x2="10" y2="60" stroke="none"/>

  <!-- legenda -->
  <rect x="700" y="56" width="410" height="330" rx="8" fill="#ffffff" stroke="#e3dccd"/>
  <text x="722" y="86" font-family="sans-serif" font-size="15" font-weight="600" fill="#144f64">Publicações de 2015–2022</text>

  <rect x="722" y="104" width="13" height="13" fill="#1c6e8c" fill-opacity="0.35" stroke="#1c6e8c"/>
  <text x="745" y="116" font-family="sans-serif" font-size="14.5" fill="#2d3748">OpenAlex · ~77,0 M</text>
  <text x="745" y="136" font-family="sans-serif" font-size="14.5" fill="#a32f2f" font-weight="600">só 21,8% está nas três</text>

  <rect x="722" y="160" width="13" height="13" fill="#a8710a" fill-opacity="0.35" stroke="#a8710a"/>
  <text x="745" y="172" font-family="sans-serif" font-size="14.5" fill="#2d3748">Web of Science · ~22,6 M</text>
  <text x="745" y="192" font-family="sans-serif" font-size="14.5" fill="#59616b">74,3% está nas três</text>

  <rect x="722" y="216" width="13" height="13" fill="#2f6f3e" fill-opacity="0.35" stroke="#2f6f3e"/>
  <text x="745" y="228" font-family="sans-serif" font-size="14.5" fill="#2d3748">Scopus · ~27,6 M</text>
  <text x="745" y="248" font-family="sans-serif" font-size="14.5" fill="#59616b">60,8% está nas três</text>

  <line x1="722" y1="272" x2="1088" y2="272" stroke="#e3dccd"/>
  <text x="722" y="296" font-family="sans-serif" font-size="14" fill="#2d3748">Corpus inteiro, todos os anos:</text>
  <text x="722" y="318" font-family="sans-serif" font-size="14" fill="#59616b">OpenAlex 243,1 M · WoS 71,3 M · Scopus 65,6 M</text>
  <text x="722" y="352" font-family="sans-serif" font-size="13" fill="#a32f2f">As áreas dos círculos estão em escala.</text>
  <text x="722" y="370" font-family="sans-serif" font-size="13" fill="#a32f2f">A forma das sobreposições, não — ver abaixo.</text>
</svg>
```

::: {.bsl-destaque}
**Quatro em cada cinco registros do OpenAlex naquele período não estão nas outras duas bases.** Buscar só na WoS ou na Scopus é trabalhar numa fatia — e é essa fatia que define o que existe, para quem busca por ali.
:::

::: {.bsl-alerta}
**O que é dado e o que é desenho:** as **interseções par-a-par não são reportadas** no artigo, então a geometria fora do núcleo comum é esquemática. Os totais de 2015–2022 foram derivados dos percentuais publicados.
:::

::: {.fonte}
Culbert JH, Hobert A, Jahn N, Haupka N, Schmidt M, Donner P, Mayr P (2025). *Reference coverage analysis of OpenAlex compared to Web of Science and Scopus*. Scientometrics. [doi:10.1007/s11192-025-05293-3](https://doi.org/10.1007/s11192-025-05293-3) · números do preprint arXiv:2401.16359
:::

## E a qualidade dos metadados {#e-a-qualidade-dos-metadados .smaller}

No mesmo corpus compartilhado de 16,8 milhões de publicações:
...
## Cada ferramenta herda o viés do seu corpus {#cada-ferramenta-herda-o-vies-do-seu-corpus .smaller}

| Ferramenta | Sobre qual base busca | Quem controla |
|---|---|---|
| **Consensus** | Semantic Scholar + OpenAlex + crawl próprio (>200 M) | empresa privada |
| **Scholar Gateway** | só o portfólio da **Wiley**: >8 M artigos de >2.000 periódicos, em texto completo | Wiley |
...
O Scholar Gateway é o contraexemplo útil: corpus **menor e de uma editora só**, mas em **texto completo**. Acha coisa que as outras não acham — e ignora tudo que não é Wiley. Os dois fatos vêm da mesma escolha de corpus.

## "Mas e o Google Scholar?" {#mas-e-o-google-scholar .smaller}

::: {.bsl-destaque}
É o que praticamente todo mundo nesta sala usa, e ele não apareceu em nenhuma lista até agora. Vale explicar **por que ele é diferente dos outros** — e quando ele continua sendo a melhor escolha.
:::

::: {.columns}
::: {.column width="50%"}
**Onde ele ganha de todos**

- **Rastreio de citações para frente** — o "Cited by". Gusenbauer (2024) avaliou os índices de citação de **59 bases** e reafirmou o Google Scholar com as **maiores contagens de citações recebidas**.
- **Cobertura larga e heterodoxa**: teses, repositórios institucionais, literatura cinzenta, não-anglófona. Pega o que OpenAlex e Semantic Scholar indexam mal — que é justamente a nossa literatura.
:::
::: {.column width="50%"}
**Onde ele perde de todos**

- **Sem API pública**, sem exportação em lote, cobertura **não documentada**, ranqueamento **não divulgado**.
- Resultados mudam por usuário, data e local.
- Não faz booleana séria: sem controle de vocabulário, sem truncagem decente, teto de resultados.
:::
:::

::: {.bsl-alerta}
Gusenbauer & Haddaway (2020) testaram **28 sistemas de busca** em precisão, revocação e reprodutibilidade e são diretos: *"our findings demonstrate why Google Scholar is inappropriate as principal search system."*
:::

## A régua do workshop aplicada ao Google Scholar {#a-regua-aplicada-ao-google-scholar .smaller}

Lembre da distinção do bloco anterior — **busca é objeto ou é evento?**

| | Google Scholar | OpenAlex via API |
|---|---|---|
| A consulta pode ir para o Methods? | não há string estável para colar | sim: o script **é** a consulta |
| Outra pessoa reexecuta em 2031? | não há garantia nenhuma | sim, com a versão da base |
| Dá para auditar o que ficou de fora? | cobertura não é publicada | o dump inteiro é baixável |
| Exporta 3.000 registros? | não | sim |

::: {.bsl-destaque}
**Conclusão prática, e ela não é "pare de usar":** o Google Scholar é excelente como **ferramenta de descoberta e de rastreio de citações**, e inadequado como **busca principal de uma revisão sistemática**. Use-o no passo das sementes e no passo das citações — e faça a busca principal onde ela possa ser escrita.
:::

::: {.fonte}
Gusenbauer M, Haddaway NR (2020). *Which academic search systems are suitable for systematic reviews or meta-analyses? Evaluating retrieval qualities of Google Scholar, PubMed, and 26 other resources*. Research Synthesis Methods 11(2):181–217. [doi:10.1002/jrsm.1378](https://doi.org/10.1002/jrsm.1378) · Gusenbauer M (2024). *Beyond Google Scholar, Scopus, and Web of Science: an evaluation of the backward and forward citation coverage of 59 databases' citation indices*. Research Synthesis Methods 15(5):802–817. [doi:10.1002/jrsm.1729](https://doi.org/10.1002/jrsm.1729) · Comparador de bases: <https://www.searchsmart.org>
:::

## O risco de usar só isso {#o-risco-de-usar-so-isso .smaller}
...
## API ou MCP? A diferença em uma frase {#api-ou-mcp-a-diferenca-em-uma-frase .smaller}
...
## openalexR: busca reprodutível em R {#openalexr-busca-reprodutivel-em-r .smaller}
...
## litsearchr: a busca booleana construída a partir dos dados {#litsearchr-a-busca-booleana-construida-a .smaller}
...
# 3 · Mão na massa {#3-mao-na-massa .bsl-secao background-color="#f3eee3"}

## A regra do bloco prático {#a-regra-do-bloco-pratico .smaller}
...
## Ferramenta A · Consensus {#ferramenta-a-consensus .smaller}
...
**Além da busca padrão, dois modos agênticos** — é aqui que o resultado muda de verdade:

| Modo | O que ele faz a mais |
|---|---|
| **Pro** | quebra a pergunta em sub-buscas, aplica filtros, percorre o grafo de citações e compõe uma resposta ancorada nas fontes |
| **Deep Search** | até **20 buscas em paralelo**, ferramentas de agente como rastreio de citações, e **50 a 100 artigos lidos** antes de responder |

::: {.bsl-destaque}
Para o exercício, rode a **busca padrão** — é ela que compara de igual para igual com o Undermind. Mas vale saber que a mesma pergunta em modo Deep devolve outra lista: **o modo é parte do método** e precisa ser declarado junto com a ferramenta.
:::

::: {.bsl-alerta}
O medidor de consenso sintetiza **o que foi recuperado**, não a literatura — se a recuperação for enviesada, ele mostra um consenso que não existe. E o **algoritmo de ranqueamento não é publicado**: não dá para auditar por que um artigo ficou em primeiro e outro em décimo.
:::

::: {.fonte}
Descrição dos modos conforme a documentação da própria Consensus: <https://docs.consensus.app/get-started/how-search-works>
:::

## Ferramenta B · Undermind {#ferramenta-b-undermind .smaller}
...
## Exercício 1 · a mesma pergunta, duas ferramentas [20 min]{.cronometro} {#exercicio-1-a-mesma-pergunta-duas-ferramentas .smaller}
...
1. Rode **a mesma pergunta** nas duas. No Consensus use a **busca padrão**.
2. Pegue os **10 primeiros** de cada uma — só o primeiro autor e o ano, não precisa copiar DOI.
3. Conte **quantos aparecem nas duas listas**. É um número de 0 a 10.
4. Se você trouxe uma revisão sua: quantas das referências que você **sabe** que são relevantes apareceram? Essa é a sua sensibilidade estimada.
:::

::: {.bsl-destaque}
**Escreva o seu número no quadro.** Vinte pessoas, vinte números: é a nossa pequena amostra, e ela vale mais que qualquer slide que eu mostre a seguir.
:::

## O que esperamos que aconteça {#o-que-esperamos-que-aconteca .smaller}
...
## Em que estágio o LLM é bom — e em qual não é {#em-que-estagio-o-llm-e-bom-e-em-qual-nao-e .smaller}
...
## O que essa figura resolve para você {#o-que-essa-figura-resolve-para-voce .smaller}
...
## A medida que resolve a discussão {#a-medida-que-resolve-a-discussao .smaller}
...
## Leia a tabela como estatístico, não como usuário {#leia-a-tabela-como-estatistico-nao-como .smaller}
...
## A mesma tabela, desenhada {#a-mesma-tabela-desenhada .smaller}
...
## E o problema mais sério: reprodutibilidade {#e-o-problema-mais-serio-reprodutibilidade .smaller}
...
## Como fica quando se faz direito {#como-fica-quando-se-faz-direito .smaller}
...
## O detalhe que salta da figura {#o-detalhe-que-salta-da-figura .smaller}
...
## Exercício 2 · a mesma pergunta, agora em R [10 min]{.cronometro} {#exercicio-2-a-mesma-pergunta-agora-em-r-10 .smaller}
...
1. Traduza sua pergunta numa consulta do `openalexR` (use o bloco do slide anterior como molde).
2. Rode e conte quantos registros vieram.
3. Compare com os 10 do Consensus: **quantos deles estão no resultado do OpenAlex?**
4. Salve o script. **Esse script é o seu Methods.**
:::

::: {.bsl-destaque}
**Não tem R funcionando? Faça pela web.** O <https://openalex.org> tem busca e filtros na interface, e exporta CSV. Você perde a reexecução automática, mas faz o exercício inteiro e enxerga a mesma coisa — e a URL da busca já é um registro melhor do que "busquei no Consensus".
:::
...
## As outras ferramentas, e onde cada uma entra {#as-outras-ferramentas-e-onde-cada-uma-entra .smaller}
...
| **NotebookLM** | não busca nada — **conversa com o seu acervo**: você sobe os PDFs e ele responde ancorado só neles, com citação de trecho | *depois* da busca: resumir os artigos que você baixou, cruzar o que eles dizem entre si, e interrogar o conjunto |

::: {.bsl-destaque}
**O NotebookLM é a etapa seguinte, e é onde ele é muito bom.** Terminada a busca, você tem 40 PDFs baixados. Subir esse acervo e perguntar a ele — *quais destes usam delineamento experimental?*, *onde eles discordam sobre o efeito da densidade?*, *qual a faixa de tamanho amostral?* — é leitura assistida sobre um corpus **que você escolheu**, com cada resposta apontando o trecho de origem. Isso resolve o mecanismo A do bloco 1: não há o que inventar, porque a fonte está no seu disco.
:::

::: {.bsl-alerta}
**O que ele não é:** ferramenta de busca. Todo tutorial da internet o coloca nessa lista. Usá-lo para "achar literatura" garante que você só encontra o que já tinha — ele não conhece nada além do que você subiu.
:::

## Um guia aberto, escrito por ecólogos {#um-guia-aberto-escrito-por-ecologos .smaller}
...
# 4 · Demonstração · agente + MCP {#4-demonstracao-agente-mcp .bsl-secao background-color="#f3eee3"}

## Custo e acesso: o Sul global paga duas vezes {#custo-e-acesso-o-sul-global-paga-duas-vezes .smaller}
...
## O que você vai ver (e o que não vai poder repetir hoje) {#o-que-voce-vai-ver-e-o-que-nao-vai-poder .smaller}

::: {.bsl-alerta}
**Aviso honesto, e é por isso que o slide anterior veio primeiro:** esta parte usa ferramenta paga. É **demonstração**, não exercício. Mostro porque é para onde o fluxo está indo — e porque o **protocolo** por baixo é aberto, ainda que o cliente não seja.
:::
...
## O que observar durante a demonstração {#o-que-observar-durante-a-demonstracao .smaller}
...
# 5 · Fechamento {#5-fechamento .bsl-secao background-color="#f3eee3"}

## Modelos abertos, rodando na sua máquina {#modelos-abertos-rodando-na-sua-maquina .smaller}
...
## O pesquisador do futuro? {#o-pesquisador-do-futuro .smaller}
...
## Como declarar uma busca assistida por IA {#como-declarar-uma-busca-assistida-por-ia .smaller}
...
## A receita, em uma página {#a-receita-em-uma-pagina .smaller}

::: {.bsl-destaque}
Fotografe este slide. É o workshop inteiro em nove linhas.
:::

| # | Etapa | Com o quê | O que registrar |
|---|---|---|---|
| 1 | Pergunta e critérios de inclusão | **você**, antes de abrir qualquer ferramenta | o texto dos critérios |
| 2 | Sementes (10–20 artigos) | Consensus / Undermind, busca padrão | ferramenta, **modo**, data |
| 3 | Termos de busca | `litsearchr` sobre as sementes | o script |
| 4 | **Busca principal** | booleana no OpenAlex (`openalexR` ou web); Scopus/WoS se houver assinatura | **a string e a data** |
| 5 | Rastreio de citações | Google Scholar, "Cited by" das sementes | quantas entraram por aqui |
| 6 | Deduplicar e guardar | **Zotero** (ou `revtools` no R) | nº antes e depois |
| 7 | Triagem de título/resumo | ASReview, ou manual com dois revisores | critério de parada |
| 8 | Leitura do acervo | NotebookLM sobre **os seus** PDFs | nada — é leitura |
| 9 | Parágrafo de Methods | **você** | tudo das colunas acima |

::: {.bsl-alerta}
A etapa 6 é a que todo mundo pula e a que mais dói depois. **Sem gerenciador de referências não há revisão** — é ali que a lista vira acervo, e é o acervo que alimenta as etapas 7 e 8.
:::

::: {.fonte}
Zotero: <https://www.zotero.org> · há assistentes de IA que trabalham **dentro** da sua biblioteca do Zotero — sobre o acervo que você já reuniu, no mesmo espírito do NotebookLM. Uma demonstração recente: Andy Stapleton, *I Finally Found an AI That Works Inside Zotero*, <https://www.youtube.com/watch?v=jc6NqXcObqc>
:::

## Síntese: cinco regras {#sintese-cinco-regras .smaller}
...
## Para continuar {#para-continuar .smaller}
...
- Search Smart (comparador de bases) — <https://www.searchsmart.org>
...
## Referências {#referencias .smaller .scrollable}
...
## Referências {#referencias-2 .smaller .scrollable}
...
- Gusenbauer M, Haddaway NR (2020). *Which academic search systems are suitable for systematic reviews or meta-analyses? Evaluating retrieval qualities of Google Scholar, PubMed, and 26 other resources*. Research Synthesis Methods 11(2):181–217. doi:10.1002/jrsm.1378
...
- *Dead Internet theory* — verbete da Wikipédia (fonte terciária, usada só para documentar a origem e a recepção da ideia). <https://en.wikipedia.org/wiki/Dead_Internet_theory>
...
- Os três diagramas esquemáticos são originais, sob CC BY 4.0

::: {.fonte}
Estes slides: © Diogo B. Provete, sob [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/deed.pt-br).
:::

## Declaração de uso de IA nesta apresentação {#declaracao-de-uso-de-ia-nesta-apresentacao .smaller}
...
As duas demonstrações do bloco 1 — a casca vazia da Cloudflare Radar e o erro 403 da Wiley — **ocorreram de fato** durante essa preparação e estão reproduzidas literalmente. Os três diagramas esquemáticos (mecanismos de erro; sensibilidade × precisão; cobertura das bases) foram desenhados para esta apresentação; as duas figuras de Scherbakov et al. (2025) são reproduções sob CC BY-NC 4.0, com a licença original preservada.
